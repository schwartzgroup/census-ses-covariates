...
#set_path_to_census("/media/qnap3/Covariates/totalcensus/")
...
# section below.
#set_path_to_census("/home/edgar/totalcensus/")

set_path_to_census("./totalcensus/")
...
for (year in c(2009:2019)) {
  for (geometry in c("tract", "block group")) {
...
output_file <- file.path(
  output_directory,
  sprintf("%d_%ss.csv", year, str_replace(geometry, " ", "_"))
)
...
#      output_directory,
#      sprintf(
#        "time_series_2010_to_2019_%ss.csv",
#        sprintf("%d_%ss.csv", year, str_replace(geometry, " ", "_"))
#      )
#    ),
#    row.names = FALSE
